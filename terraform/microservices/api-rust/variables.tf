# Variables for Rust Actix API Service Infrastructure
...
variable "enable_rust_api" {
  description = "Whether to enable the Rust API service"
  type        = bool
  default     = false
}
...
variable "container_image" {
  description = "Docker image for the Rust API service"
  type        = string
  default     = "nexpo/api-rust:latest"
}
