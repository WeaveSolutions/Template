# Variables for .NET ASP.NET Core API Service

variable "enable_dotnet_api" {
  description = "Enable deployment of the .NET ASP.NET Core API service"
  type        = bool
  default     = false
}
...
variable "container_image" {
  description = "Docker image for the .NET API service"
  type        = string
  default     = "nexpo/dotnet-api:latest"
}
