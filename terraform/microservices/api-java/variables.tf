# Java Spring Boot API Service Variables

# Service Configuration
variable "enable_java_api" {
  description = "Enable Java Spring Boot API service deployment"
  type        = bool
  default     = true
}
...
variable "container_image" {
  description = "Docker image for Java Spring Boot API service"
  type        = string
  default     = "nexpo/api-java:latest"
}
...
variable "java_opts" {
  ...
  type        = string
  default     = "-Xmx1g -Xms512m -XX:+UseG1GC"
}
...
variable "management_endpoints_enabled" {
  description = "Enable Spring Boot Actuator endpoints"
  type        = bool
  default     = true
}

variable "management_security_enabled" {
  description = "Enable security for management endpoints"
  type        = bool
  default     = true
}
