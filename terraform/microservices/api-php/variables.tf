# Variables for PHP Laravel API Service Infrastructure
...
variable "enable_php_api" {
  description = "Whether to enable the PHP API service"
  type        = bool
  default     = false
}
...
variable "container_image" {
  description = "Docker image for the PHP API service"
  type        = string
  default     = "nexpo/api-php:latest"
}
