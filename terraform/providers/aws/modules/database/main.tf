# Database Module - RDS PostgreSQL and DynamoDB
# Following Well-Architected Framework for reliability and performance
...
# DynamoDB Tables for session storage and caching
...
resource "aws_cloudwatch_metric_alarm" "db_storage" {
  ...
  period              = "300"
  statistic           = "Average"
  threshold           = var.db_storage_threshold * 1024 * 1024 * 1024 # Convert GB to bytes
