# CRA Auth Microservice

A Central Rank Authority (CRA) aligned authentication microservice built with Express.js, Auth0, and Kong API Gateway integration.

## Architecture Overview

This microservice implements the authentication patterns documented in the [CRA Authentication Documentation](../../../docs/Authentication/CRA.md), featuring:
...
- **Security First**: Helmet CSP, rate limiting, CORS whitelisting
