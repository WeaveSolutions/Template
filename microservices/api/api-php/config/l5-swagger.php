    ...
    'defaults' => [
        ...
        'paths' => [
            ...
            */
             ...
             * @deprecated Please use `scan.exclude`
             * `scanner.exclude` overwrites this
            */
            'excludes' => [],
        ],
        ...
        'scanOptions' => [
            ...
            /**
             * pattern: defaults to a case-insensitive glob pattern to find PHP files.
             *
             * @see \OpenApi\scan
             */
            'pattern' => null,
        ...
        */
         ...
         */
        'constants' => [
            'L5_SWAGGER_CONST_HOST' => env('L5_SWAGGER_CONST_HOST', 'http://localhost:7080'),
        ],
    ],
];
